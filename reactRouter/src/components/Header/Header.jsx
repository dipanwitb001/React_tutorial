...
// Link is used in place of a tag. a tag refereshes the page everytime
            ...
            <div className='flex flex-wrap justify-between items-center mx-auto max-w-screen-xl'>
                ...
                <div className='flex items-center lg:order-2'>
                    <Link
                        ...
                        focus:ring-gray-300 font font-medium
...
// here the class is written with callBack, to tell user in which page ois active i.e with /(for more clarity refer to video no 12, 15:00 time stamp), with Navlink, isActive is available
